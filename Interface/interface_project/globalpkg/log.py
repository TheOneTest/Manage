...
class LogSignleton(object):
    ...
    def __new__(cls, log_config):
        ...
        if not hasattr(cls, 'instance'):
            ...
            with codecs.open(log_config, 'r', encoding='utf-8') as f:
                config.readfp(f)
...
logsignleton = LogSignleton('C:\Users\XYZ\Desktop\TheOne\Interface\interface_project\config\logconfig.conf')
